define([
    ...
    'CSSoft_CodeReflector/js/loadCss',
    'CSSoft_CodeReflector/js/codemirror/lib/codemirror'
    ...
    function getRequired(editorConfig) {
        ...
        return _.map(files || [], function (path) {
            return 'CSSoft_CodeReflector/js/codemirror/' + path;
        });
    }
    ...
    return Textarea.extend({
        defaults: {
            plugins: {},
            elementTmpl: 'CSSoft_CodeReflector/form/element/editor',
            inputClass: '',
            editorConfig: {
                indentUnit: 4,
                lineNumbers: true,
        ...
        plugin: function (name) {
            var self = this,
                path = 'CSSoft_CodeReflector/js/form/element/editor-plugins/';
